        ...
        <div class="wrapper" ref="wrapper">
            <div class="content">
                ...
                <div class="entertainment_wrapper">
                    <div class="findFri_btn"
                         :data-step="homeIntro.friend.step"
                         :data-intro="homeIntro.friend.intro"
                         :data-position="homeIntro.friend.position"
                         :data-disable-interaction="true"
                         @click="gotoFriend">
                        <img id="step1"
                             src="../../assets/image/findFri.png" alt />
                    ...
                    <div class="playGame_btn"
                         ...
                         :data-disable-interaction="true" id="step2" @click="gotoPlay">
                            ...
                            <li class="item clearfix" v-for="(item,index) in friendLeagleList" :key="index">
                                ...
                                <div class="right">
                                    ...
                                    <div style="margin-left:.3rem"
                                         class="receive_btn" @click="goToFriShop(item)">领&nbsp;&nbsp;&nbsp;取</div>
                                </div>
                            </li>
                        </ul>
                    </div>
