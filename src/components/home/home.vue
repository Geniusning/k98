            ...
            <div class="content">
                ...
                <div class="entertainment_wrapper">
                    <div
                         ...
                         @click="gotoFriend">
                        <img
                             src="../../assets/image/findFri.png"
                             alt />
                        <div class="desc_wrapper">
                            <div class="lineOne">
                                <ul
                                    class="fri_list"
                                    v-show="friendIconList1.length>=3">
                                    <li
                                        class="item"
                                        :class="'avar'+index"
                ...
                <div
                    ...
                    <div
                         class="welfare_content"
                         v-if="recommentList.length">
                        <ul
                            class="welfare_list"
                            v-if="recommentList.length">
                            <li
                                ...
                                <div class="right">
                                    <div class="thunb_box">
                                        <div
                                             class="booking_btn"
                                             @click="freeBook(item.goods.ID,index)">积分兑换</div>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul
                            ...
                            <li
                                ...
                                <div class="center">
                                    <p
                                       class="title"
                                       style="font-weight:900">{{item.res.name}}</p>
                                ...
                                <div class="right">
                                    ...
                                    <div
                                         ...
                                         class="receive_btn"
                                         @click="goToFriShop(item)">领&nbsp;&nbsp;&nbsp;取</div>
                                </div>
                            </li>
                        </ul>
                    </div>
