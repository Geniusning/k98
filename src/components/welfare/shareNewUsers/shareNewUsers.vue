<template>
  <div class="shareNew-wrapper" id="shareNew">
    ...
    <img src="../../../assets/image/newUsers.jpg" alt="" class="sharePic">
    ...
    <div class="handle-container">
      <img @click="back" class="btn" src="../../../assets/image/getDiscount.png" alt="">
      <img @click="share" class="btn" src="../../../assets/image/givePresent.png" alt="">
    </div>
