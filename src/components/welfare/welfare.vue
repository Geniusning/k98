  ...
  <div id="welfare" class="welfare">
    ...
    <div class="logo-container">
      <div class="logo-wrapper">
        <img onclick="return false" :src="activityNoticeList.length>0?activityNoticeList[0].image:tempPic" alt style=" width: 9.2rem;height:100%">
        <p class="reserve">
          优惠进行中 预定热线
    ...
    <div v-show="activityNoticeList.length>0" style="background:#fff;padding:.2667rem">
      <div class="activity-wrapper">
        <div class="title"><span class="title_text">活动告示板</span></div>
