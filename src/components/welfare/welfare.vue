    ...
    <div id="welfare" class="welfare">
        ...
        <div class="logo-container">
            <div class="logo-wrapper">
                <swiper height="150px" v-if="oldPhoto_list.length>0" :show-dots="false" :auto="true" class="slider" :loop="true" :list="oldPhoto_list" v-model="index_pic"></swiper>
                <img v-else onclick="return false" :src="activityNoticeList.length>0?activityNoticeList[0].image:tempPic" alt style=" width: 9.2rem;height:100%">
            </div>
        </div>
        <!-- 分享有礼 -->
