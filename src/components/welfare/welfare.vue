<template>
    <div id="welfare"
        ...
        <div class="share-wrapper"
            ...
            <img onclick="return false"
                 @click="shareNewFriend"
                 src="../../assets/image/share_enter.png"
                 class="shareEnter"
                 alt>
        </div>
        <!-- 活动通知 -->
        <div v-show="activityNoticeList.length>0"
             style="background:#fff;padding:.2667rem">
            <div class="activity-wrapper">
                <div class="title"><span class="title_text">告示板</span></div>
                <ul class="activityList"
                    v-if="activityNoticeList.length>0">
                    <li class="item-active"
                        v-for="(item,index) in activityNoticeList"
                        :key="index">
                        <img onclick="return false"
                             :src="item.image"
                             style="width:2.8533rem;height:2.1333rem"
                             alt
                             class="picActive">
                        <div class="desc_box">
                            ...
                            <div class="detailBtnBox">
                                <button class="btn"
                                        @click="showActivityDetail(item.activityID)">查看详情</button>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="game-wrapper">
            <div v-if="isShowGameEntry"
                 class="broadcasting-room"
                 @click="playGame">立即参与></div>
            <div class="game-content">
                ...
                <div class="handle-wrapper">
                    <button class="btnRecord"
                            @click="goToGameRecord">查看往期赛事</button>
                    <button class="btnPlayGame"
                ...
                <div ref="rankList">
                    <ul class="rankList"
                        ...
                        <li class="item"
                            ...
                            <div class="itemLeft">
                                <p class="rank"
                                   :class="{first:index===0,second:index===1,third:index===2}">第{{index+1}}名</p>
                            </div>
                            <div class="itemright">
