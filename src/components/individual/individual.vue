    ...
    <div id="individual" class="individual">
        ...
        <div class="scrollBox vux-1px-t">
            ...
            <div class="avatar_wrapper clearfix">
                ...
                <div class="divideBTn" @click="goToDivide" v-if="userInfo.role != 'divide' && userInfo.role !='' && !(userInfo.openid.indexOf('master')>-1)">
                    <span>新增</span>
                    <span>分身</span>
                </div>
            </div>
            ...
            <div class="userInfo_wrapper">
                <ul class="userInfo_list">
                    ...
                    <li class="item vux-1px-b" @click="showPopupPickerPos=true">
                        <span class="item_name">所属行业</span>
                        <input type="text" class="input_name" v-model="position" disabled />
                        <img onclick="return false" src="../../assets/image/arrow_right.png" alt class="arrow_right" />
                    </li>
                    <li class="item vux-1px-b">
                        <span class="item_name">籍贯</span>
                        <el-cascader size="large" :options="options" v-model="selectedHomeTownOptions" @change="handleChangeHomeTown"></el-cascader>
                    </li>
                    <li class="item vux-1px-b">
                    ...
                    <li class="item vux-1px-b">
                        ...
                        <input type="number" class="input_name" v-model="phone" @blur="blurAdjust" />
                    </li>
                    ...
                    <li class="item">
                        ...
                        <div class="authority_wrapper">
                            <ul class="authority_list">
                                ...
                                <li style="font-size: 0.3733rem;" class="authorItem">
                                    <group>
                                        <x-switch title="挂免战牌,不接受大话骰挑战" :value-map="[false, true]" @on-change="changeBattle" v-model="isBattle"></x-switch>
                                    </group>
                                </li>
                                <li style="font-size: 0.3733rem;" class="authorItem">
                                    <group>
                                        <x-switch title="关闭评论/留言" :value-map="[false, true]" @on-change="changeComment" v-model="isComment"></x-switch>
                                    </group>
                                </li>
                            </ul>
                        </div>
        ...
        <!-- 个性标签选择 -->
        <div v-transfer-dom>
            <x-dialog v-model="tagShow" class="dialog-demo" style="height:100%;z-index:-1">
        ...
        <!--  -->
        <popup-picker :show="showPopupPickerPos" :data="positionList" v-model="positionArr" @on-hide="onHide_P" @on-change="onChange_P"></popup-picker>
    </div>
</template>
...
export default {
    ...
    mounted () {
        ...
        this.homeTown = this.userInfo.hometown
