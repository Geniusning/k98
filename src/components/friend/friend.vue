<template>
    <div id="friend" class="friend">
        <div class="nav">
            <img
                 :data-step="friendIntro.setting.step"
                 :data-intro="friendIntro.setting.intro"
                 :data-position="friendIntro.setting.position"
                 :data-disable-interaction="true" class="slelct" onclick="return false" src="../../assets/image/select.png" alt @click="showToast=true" />
            <div class="shopInfo">
        ...
        <div class="stack-wrapper">
            <div class="switchBtn_wrapper"
                 :data-step="friendIntro.soul.step"
                 :data-intro="friendIntro.soul.intro"
                 :data-position="friendIntro.soul.position"
                 :data-disable-interaction="true" @click="switchMakeFriModal">
                <div class="imgBox">
