        ...
        <div class="big_box" v-if="!soulSwitch">
          <div class="img_content">
            ...
            <div class="comment-photo">
              <div
                ...
                v-show="item.info.role != '' && l98Setting.staffCommentOpen"
              >
                <img
                  onclick="return false"
              ...
              <div
                class="avatarList-wrapper clearfix"
                @touchstart="showAlbum(item.info)"
                v-if="item.info.lifePhotoURL.lifePhotoURL &&item.info.lifePhotoURL.lifePhotoURL.length>0"
              >
                <img
                  onclick="return false"
          ...
          <div class="userInfo_wrapper">
            <div class="userBox clearfix">
              ...
              <span
                class="constellation"
              >{{item.info.constellation?item.info.constellation.slice(0,3):"水瓶座"}}</span>
  ...
  methods: {
    ...
    touchend(e) {
      ...
      if (this.offsetRatio >= 0.15) {
        ...
        this.poswidth =
          this.poswidth >= 0 ? this.poswidth + 200 : this.poswidth - 200;
        this.posheight =
          this.posheight >= 0
    ...
    nextTick() {
      ...
      if (this.backToParentData.info.phone != "") {
        //显示员工被点赞次数
        this.loadStaffCommentInfo(this.backToParentData.info.phone);
      }
      let signList = [
        "努力吧,别把自己的青春铺张在爱情上",
        "兄弟虽然我们是在网络中相遇",
