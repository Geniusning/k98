        ...
        <div class="big_box"
            ...
            <div class="comment-photo">
              ...
              <div class="comment-wrapper clearfix"
                ...
                <img onclick="return false"
                     ...
                     v-show="thumbCount">
                <span v-show="thumbCount"
                      class="count fl"
                      style="margin-right:.1rem;margin-top:.08rem">{{thumbCount}}</span>
                <span class="count fl"
                      v-if="item.info.sex==1">了解他...</span>
                <span class="count fl"
                      v-else>了解她...</span>
              </div>
          ...
          <div class="userInfo_wrapper"
            ...
            <div class="userBox clearfix">
              ...
              <span class="gift">助推{{item.info.flowerCounts}} <img src="../../../assets/image/flowerCounts.png"
                     class="flower"
                     alt=""></span>
              <div class="thumb">
            ...
            <div class="tag_wrapper">
              ...
              <span v-for="(item,index) in item.info.tags?item.info.tags.split('、'):tempArr.split('、')"
                    :key="index">{{item}}</span>
            </div>
...
export default {
  ...
  watch: {
    ...
    pages (newValue) {
      ...
      if (newValue.length <= 12) {
        this.loadStaffCommentInfo(data.info.openid);
  ...
  methods: {
    ...
    nextTick () {
      ...
      this.loadStaffCommentInfo(this.backToParentData.info.openid);
      let signList = [
        "努力吧,别把自己的青春铺张在爱情上",
        "兄弟虽然我们是在网络中相遇",
