...
export default {
    ...
    created() {
				...
				console.log("this.scopeOpenId1-----",this.scopeOpenId)
				this.scopeOpenId = urlOpenId?urlOpenId:this.scopeOpenId
				console.log("this.scopeOpenId2---",this.scopeOpenId)
    ...
    mounted() {
        setTimeout(() => {
            let shareObj = {
                title: "找朋友",
                desc: "我看行……大伙帮Ta捧个场吧",
                link: `${this.shareUrl}k98/commentUser?openId=${this.scopeOpenId}`,
