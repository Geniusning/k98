    ...
    <div class="content">
      <header>
        <div class="comment-header-left">
          <img :src="staffInfo.headImgUrl" class="comment-avatarUrl" alt="">
          <span class="comment-name">{{staffInfo.nickname}}</span>
        </div>
          ...
          <div>
            <div v-if="staffCommentInfo.thumbAvatarList" class="comment-thums-list">
              ...
              <ul class="thumb-avatar-list">
                <li
                  class="avatar"
                  v-for="(avatar,index) in staffCommentInfo.thumbAvatarList"
                  :key="index"
                >
