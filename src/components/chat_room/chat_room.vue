                  ...
                  <div v-else>
                    <div>
                      ...
                      <div class="myGifoInfo" :class="{'friendPanel':item.friend,'minePanel':!item.friend}" v-else>
                        ...
                        <div>
                          <p v-if="!item.isBeFriendModel" class="giftRecord_test giftText"><span @click="respondForGift(item,false,item.isBeFriendModel)" class="no">拒收</span><span @click="respondForGift(item,true,item.isBeFriendModel)" class="yes">感谢</span></p>
                ...
                <div>
                  ...
                  <div v-else>
                    <div>
                      ...
                      <p v-else class="giftRecord_test no_received">{{staticChatFriendObj.nickname}}约{{userInfo.nickname}}玩一把游戏<span @click="rejectForGame(item)" class="noGame">免战</span><span @click="respondForGame(item)" class="yesGame">应战</span></p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          for (i = resultMessList.length - 1; i >= 0; i--) {
            ...
            this.componentChatList.unshift({
              ...
              couponID: item.chatExtMsg
                ? item.chatExtMsg.extMsg ? item.chatExtMsg.extMsg.couponID : ""
                : "",
              recordID: item.chatExtMsg
                ? item.chatExtMsg.extMsg ? item.chatExtMsg.extMsg.recordID : ""
                : "",
              name: item.chatExtMsg
                ? item.chatExtMsg.extMsg ? item.chatExtMsg.extMsg.name : ""
                : "",
              combatID: item.chatExtMsg
                ? item.chatExtMsg.extMsg ? item.chatExtMsg.extMsg.combatID : ""
                : "",
              inviterID: item.chatExtMsg
                ? item.chatExtMsg.extMsg ? item.chatExtMsg.extMsg.inviterID : ""
                : "",
              url: item.chatExtMsg
