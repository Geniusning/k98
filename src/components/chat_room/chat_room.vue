    ...
    >
      ...
      <div class="chat_nav">
        ...
        <div
          ...
          @click="goToComment(staticChatFriendObj)"
        >
          <!-- <img
                        onclick="return false"
            ...
            >
              ...
              >
                ...
                <div class="message_box">
                  ...
                  <div
                    class="dot"
                    v-if="item.friend &&!item.vocieUnread"
                  ></div>
                  <img
                    v-if="item.outOfDate"
              ...
              <div
                v-else-if="item.type==3 || item.type==8"
                class="gift_wrapper"
              >
        ...
        <div class="select_area">
          <ul class="selectList clearfix">
            ...
            >
              <img
                onclick="return false"
                src="../../assets/image/chat_gift.png"
                alt
              />
            </li>
            <li class="item fl">
      ...
      >
        <img
          class="voicing-micro"
          src="../../assets/image/micro_icon.png"
          alt
        />
