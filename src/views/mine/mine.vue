<template>
  <div id="mine" class="mine">
    ...
    <div class="personInfo_content">
      ...
      <div :data-step="mineIntro.setting.step" :data-intro="mineIntro.setting.intro" :data-position="mineIntro.setting.position" :data-disable-interaction="true" class="edit" @click="edit_individual">
        <img onclick="return false" src="../../assets/image/setting.png" alt class="editIcon">
        <div class="editText">设置</div>
      </div>
      <div :data-step="mineIntro.comment.step" :data-intro="mineIntro.comment.intro" :data-position="mineIntro.comment.position" :data-disable-interaction="true" class="commentEntry" @click="goToMyComment">
    ...
    <div class="content">
      ...
      <!-- 签到  :data-step="mineIntro.sign.step"
          ...
          <ul class="welfare_list" v-if="sendGiftList.length">
            <li class="item clearfix" v-for="(item,index) in sendGiftList" :key="index">
              ...
              <div class="right">
                ...
                <div class="linear_btn" @click="convert(item.goods.ID,index)">积分兑换</div>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="marketing_wrapper">
        ...
        <ul class="marketing-list">
          <li class="marketing-item">
            ...
            <div class="linear_btn" @click="goToMyComment">去分享</div>
          </li>
          <li class="marketing-item">
            <div class="marketing-left">门店名片(首页)</div>
            <div class="marketing-c">(点右上角，送20分)</div>
            <div class="linear_btn" @click="homeShare">去分享</div>
          </li>
          <li class="marketing-item" v-if="noCouponsFlag">
            <div class="marketing-left">邀新有礼</div>
            <div class="marketing-c">(点右上角，送20分)</div>
            <div class="linear_btn" @click="inviteShare">去分享</div>
          </li>
          <li class="marketing-item">
            <div class="marketing-left">找朋友，缘分送好友</div>
            <div class="marketing-c">(点右上角，送20分)</div>
            <div class="linear_btn" @click="friShare">去分享</div>
          </li>
          <li class="marketing-item">
            <div class="marketing-left">大话赛，智商大比拼</div>
            <div class="marketing-c">(点右上角，送20分)</div>
            <div class="linear_btn" @click="gameShare">去分享</div>
          </li>
        </ul>
      </div>
    </div>
