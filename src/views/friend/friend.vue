<template>
  <div id="friend" class="friend">
    <div class="nav">
      <img :data-step="friendIntro.setting.step" :data-intro="friendIntro.setting.intro" :data-position="friendIntro.setting.position" :data-disable-interaction="true" class="slelct" onclick="return false" src="../../assets/image/select.png" alt @click="showToast=true" />
      <div class="shopInfo">
    ...
    <div class="stack-wrapper">
      <div class="switchBtn_wrapper" :data-step="friendIntro.soul.step" :data-intro="friendIntro.soul.intro" :data-position="friendIntro.soul.position" :data-disable-interaction="true" @click="switchMakeFriModal">
        <div class="imgBox">
      ...
      <div v-if="hideArrow">
        ...
        <img :data-step="friendIntro.left.step" :data-intro="friendIntro.left.intro" :data-position="friendIntro.left.position" :data-disable-interaction="true" src="../../assets/image/arrow left.png" alt class="arrow_left" />
        <img :data-step="friendIntro.right.step" :data-intro="friendIntro.right.intro" :data-position="friendIntro.right.position" :data-disable-interaction="true" src="../../assets/image/Arrow Right.png" alt class="arrow_right" />
    ...
    <div class="control_wrapper">
      ...
      <div class="btns_wrapper" v-show="!soulSwitch">
        <div :data-step="friendIntro.gift.step" :data-intro="friendIntro.gift.intro" :data-position="friendIntro.gift.position" :data-disable-interaction="true" class="gifts">
        ...
        <!--  -->
        <div class="thumbs" :data-step="friendIntro.thumb.step" :data-intro="friendIntro.thumb.intro" :data-position="friendIntro.thumb.position" :data-disable-interaction="true" v-if="!isFriend">
        ...
        <div :data-step="friendIntro.thumb.step" :data-intro="friendIntro.thumb.intro" :data-position="friendIntro.thumb.position" :data-disable-interaction="true" class="hello" v-else>
          <img onclick="return false" src="../../assets/image/sayhi.png" @click="chat" alt />
          <!-- <img onclick="return false" src="../../assets/image/thumbs-o-up.png" v-show="isFirstLoad" class="guideThumbs" alt /> -->
          <!-- <p class="handleText" v-show="isFirstLoad">互赞成好友</p> -->
        </div>
        <div :data-step="friendIntro.play.step" :data-intro="friendIntro.play.intro" :data-position="friendIntro.play.position" :data-disable-interaction="true" class="playGame">
  ...
  beforeRouteEnter (to, from, next) {
    next((vm) => {
      ...
      let shareObj = {
        ...
        link: `${vm.shareUrl}#/friend?visitType=12&phone=${vm.userInfo.phone
