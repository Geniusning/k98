 ...
 * @Last Modified time: 2019-12-04 18:38:10
 */
...
let api = {};
//回应游戏带被邀请队列
api.queueCombatReply = function(p) {
    return new Promise((resolve, reject) => {
        axios.post(shareurl + `game/queueCombatReply`,p).then(res => {
            if (res.status == 200) {
                resolve(res.data)
            }
        }).catch(err => {
...
api.enforceLeaveRoom = function() {
    return new Promise((resolve, reject) => {
        axios.get(shareurl + `game/enforceLeaveRoom`).then(res => {
            if (res.status == 200) {
                resolve(res.data)
            }
        }).catch(err => {
...
api.addWaitingCombatList = function() {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/addWaitingCombatList`).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.loadClientServiceList = function(phone) {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/loadClientServiceList?phone=${phone}`).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.loadL98otherSetting = function() {
    ...
    //加载同桌信息
api.loadDeskRoomInfo = function (deskCode) {
        return new Promise((resolve, reject) => {
            axios.get(shareurl + `game/loadDeskRoomInfo?deskCode=${deskCode}`).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.loadLastRoomInfo = function() {
        return new Promise((resolve, reject) => {
            axios.get(shareurl + `game/loadLastRoomInfo`).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.sendImageCliSer = function(fromIconURI, openId, from, fileName, param) {
        return new Promise((resolve, reject) => {
            axios.post(Url.commonUrl + `/api/sendImageCliSer?to=${openId}&from=${from}&fileName=${fileName}&fromIconURI=${fromIconURI}`, param).then((res) => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.loadInviteCoupon = function() {
        return new Promise((resolve, reject) => {
            axios.get(`/api/loadInviteCoupon`)
                .then(res => {
                    if (res.status == 200) {
                        resolve(res.data)
                    }
...
api.createShareDaylog = function(shareType) {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/createShareDaylog?shareType=${shareType}`)
                .then(res => {
                    if (res.status == 200) {
                        resolve(res.data)
                    }
...
api.acquireInviteCoupon = function(couponID, type, activityId) {
    return new Promise((resolve, reject) => {
        axios.get(Url.commonUrl + `/api/acquireInviteCoupon?couponID=${couponID}&abCoupon=${type}&activityId=${activityId}`)
            .then(res => {
                if (res.status == 200) {
