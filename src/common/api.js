 ...
 * @Last Modified time: 2019-12-04 18:38:46
 */
...
api.queueCombatReply = function(p) {
        return new Promise((resolve, reject) => {
            axios.post("https://llwant1.qianz.com/" + `game/queueCombatReply?tk=${Url.tk}`,p).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.enforceLeaveRoom = function() {
        return new Promise((resolve, reject) => {
            axios.get("https://llwant1.qianz.com/" + `game/enforceLeaveRoom?tk=${Url.tk}`).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.loadDeskRoomInfo = function (deskCode) {
        return new Promise((resolve, reject) => {
            axios.get("https://llwant1.qianz.com/" + `game/loadDeskRoomInfo?tk=${Url.tk}&deskCode=${deskCode}`).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.loadLastRoomInfo = function() {
        return new Promise((resolve, reject) => {
            axios.get("https://llwant1.qianz.com/" + `game/loadLastRoomInfo?tk=${Url.tk}`).then(res => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
