 ...
 * @Last Modified time: 2020-10-12 09:29:13
 */
...
api.delCommentInfo = function(flag, data) {
        return new Promise((resolve, reject) => {
            axios.post(Url.commonUrl + `/api/delCommentInfo?flag=${flag}&tk=${Url.tk}`, data).then((res) => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.addVisitRecord = function(pageType) {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/addVisitRecord?pageType=${pageType}&tk=${Url.tk}`).then((res) => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.getNewestSelfPay = function(clientID) {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/getNewestSelfPay?clientID=${clientID}&tk=${Url.tk}`).then((res) => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.replyVipService = function(openid) {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/replyVipService?targetID=${openid}&tk=${Url.tk}`).then((res) => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.getPlaceOrderQRcodebyID = function(deskID) {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/getPlaceOrderQRcodebyID?deskID=${deskID}&tk=${Url.tk}`).then((res) => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
...
api.beFriend = function(target) {
        return new Promise((resolve, reject) => {
            axios.get(Url.commonUrl + `/api/beFriend?target=${target}&tk=${Url.tk}`).then((res) => {
                if (res.status == 200) {
                    resolve(res.data)
                }
            }).catch(err => {
