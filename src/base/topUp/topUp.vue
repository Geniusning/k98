    ...
    <transition name="fade" mode="out-in">
        ...
        <div class="coinBox_top vux-1px-b">
          <div class="integral_box">
            <img
              ...
              src="../../assets/image/integralIcon.png"
              alt="icon"
              class="integral"
            >
            <p class="integral_text">
              ...
              <span
                v-if="showOweText"
              >尚欠积分:{{Math.abs(userInfo.money-componentGiftInfo.goods.integral)}}</span>
            </p>
          </div>
          <img
            onclick="return false"
        ...
        <div class="coinBox_bottom">
          <ul class="coinList">
            <li
              ...
              :key="item.id"
              @click="payForCoin(item.id,index,item.points)"
            >
              <img
                onclick="return false"
                :src="item.imgUrl"
                :class="[item.iconClass,{bigAndSamll:index===clickIndex}]"
              >
      ...
      <div class="giftPanelBox" v-else-if="panelIndex===1" key="giftPanelBox">
        ...
        <div class="giftListpart vux-1px-b">
          <img
            onclick="return false"
            v-show="componentGiftList.length>0"
            src="../../assets/image/integralIcon.png"
            alt=""
            class="integralIcon"
          >
          ...
          <ul class="list">
            <li
              class="item"
              v-for="(item,index) in componentGiftList"
              :key="index"
              @click="sendVirtualGift(item.id,index,item)"
            >
      ...
      <div class="sendGiftPanelBox" v-else-if="panelIndex===2" key="sendGiftPanelBox">
        <div class="header">
          <img
            onclick="return false"
            v-if="componentConvertType == 0 || componentConvertType == 1"
            src="../../assets/image/integralIcon.png"
            class="giftBoxIfon"
          >
          <img
            onclick="return false"
            v-else
            src="../../assets/image/giftBox.png"
            class="giftBoxIfon"
          >
          <p
            class="header_text"
          >消耗积分{{componentGiftInfo.goods.integral}} &nbsp;&nbsp;&nbsp;我的积分:{{userInfo.money}}</p>
        ...
        <div class="content">
          <div class="pictureBox">
            <img
              onclick="return false"
              :src="componentGiftInfo.goods.image"
              alt=""
              class="pictureBox_img"
            >
          </div>
          <div class="componentGiftInfoBox">
            ...
            <p
              class="price"
              v-if="componentConvertType===0 ||componentConvertType===1||componentConvertType===2 ||componentConvertType===3"
            >
              原价￥{{componentGiftInfo.goods.discountPrice}}&nbsp;&nbsp;&nbsp;
              <span
                style="color:red"
              >积分换${{componentGiftInfo.goods.integral}}</span>
            </p>
        ...
        <div class="handle">
          ...
          <div
            v-if="componentConvertType===0 || componentConvertType===1"
            class="btn"
            @click="confirmShopItemGift(componentGiftInfo.goods.id)"
          >确认</div>
...
>>>>>>> db009f6df5300d9695dab97d6e2cbfac41c647c2
          <!-- </div> -->
      ...
      <div class="successfullyBox" v-else-if="panelIndex===3" key="successfullyBox">
        <div class="envelope">
          ...
          <div class="integralIcon_wrapper">
            ...
            >
            <div
              class="integralIcon_text"
            >消耗积分:{{componentGiftInfo.goods.integral}} &nbsp;&nbsp;&nbsp;我的积分:{{userInfo.money}}</div>
          </div>
